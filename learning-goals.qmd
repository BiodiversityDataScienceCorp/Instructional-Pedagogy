...
you anticipate questions that only an expert (like yourself) would think to 
ask. In these cases, we may never get around to thinking about how to get our 
students from one point to the next, and how to know when they've gotten there. 
In this session, we will focus on strategies for designing content to achieve 
...
Last week we focused on developing skill, the limits of memory, and how 
learning works. What areas would you like more clarification on? What areas are 
you excited to apply in your classroom? Start by discussing this with your 
group for 10 minutes, then choose a spokesperson who will report back to the 
larger group.
...
2. Decide what constitutes evidence that objectives have been met
3. Design assessments to target that evidence
4. Design instruction by sorting assessments in order of increasing complexity, 
...
objectives. Here is a list of learning objectives from a 
...
to tell if a student learned the material. In contrast, the following specific 
objectives will be easier to write assessments for:
...
Think about a tool (software or otherwise) that you use or teach often. If you 
were to write a lesson to train students how to use that tool, what are three 
learning objectives that would help guide the development of your lesson? Write 
the tool or analysis and your learning objectives in the collaborative 
document.
...
the ones we described previously (multiple choice questions, faded examples, 
Parson’s problems, or diagram labeling). After creating this assessment, 
explain to your group how you expect it to reinforce what you taught and/or 
identify misconceptions students may have.

+ Write an assessment (5 minutes)
+ Explain to your group how it reinforces concepts and/or identifies 
misconceptions (10 minutes)
...
So how you _do_ you assess students' progress without asking? One way is to ask 
for quick check-ins. If you are teaching in-person, you can start the class by 
