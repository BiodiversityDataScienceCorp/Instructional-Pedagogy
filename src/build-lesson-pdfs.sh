...
cat 2-2-motivation.md docs/lesson-notes-footer.md | pandoc -f markdown -o 2-2-motivation.pdf
cat 2-3-eia.md docs/lesson-notes-footer.md | pandoc -f markdown -o 2-3-eia.pdf
