...
presentation. We will finish this section by practicing live coding and 
...
student's and an instructor's point of view in the collaborative
...
Googling for the answer as one of your steps to address the error (but maybe 
not the _first_ step you take).
...
demo video: [https://youtu.be/SkPmwe_WjeY](https://youtu.be/SkPmwe_WjeY). 
Summarize your feedback on both videos in the collaborative document. Use the 
2x2 (positive/negative, content/presentation) rubric for feedback we discussed 
earlier. In the videos, the instructor is teaching students how to use loops to 
repeat a task. Note: Sometime sounds in the room can be poor. Turning on 
closed captioning by pressing the [cc] button will improve the accessibility of 
these videos.
...
3. Have each group member teach 5 minutes of your chosen lesson episode using 
...
4. Use your screen wisely. Use a big font, and maximize the window. A black 
font on a white background usually works better than a light font on a dark
background. 
...
6. Leave no student behind. We will talk later in the workshop about strategies 
that can be used to gauge students' progress and understanding.
...
Return to your groups and repeat the previous live-coding exercise, re-teaching
the same content as before. This time, the presenter should incorporate changes
based on feedback received, and everyone should try to "level up" their 
feedback.
